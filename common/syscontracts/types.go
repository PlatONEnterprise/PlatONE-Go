...
var (
	...
	PARAMETER_MANAGEMENT_ADDRESS = common.HexToAddress("0x0000000000000000000000000000000000000011") // The PlatONE Precompiled contract addr for parameter management
