...
#ifdef ENABLE_TRACE
#define TRACE(...) bcwasm::println("file", __FILE__, "func", __func__, "line", __LINE__, ##__VA_ARGS__)
#else
#define TRACE(...)
#endif

#ifdef ENABLE_TRACE
#define DEBUG(...) bcwasm::println("file", __FILE__, "func", __func__, "line", __LINE__, ##__VA_ARGS__)
#else
#define DEBUG(...)  bcwasm::println(__VA_ARGS__)
#endif
