...
Except --all flag, other search keys can be combined.`,
	...
	ContractApprove = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		platonecli admin contract approve <address> <operation>`,
	}
	...
	ContractAdd = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		platonecli admin contract add <name> <address>`,
	}
	...
	ContractDelete = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		platonecli admin contract delete <address> <roles>`,
	}
	...
	ContractList = cli.Command{
		...
		Description: `
		platonecli admin contract list`,
	}
	...
	UserApprove = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		platonecli admin user approve <address> <operation>`,
	}
	...
	UserDelete = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		platonecli admin user delete <address>`,
	}
	...
	UserEnable = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		platonecli admin user enable <address>`,
	}
	...
	UserDisable = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		platonecli admin user disable <address>`,
	}
	...
	SupApprove = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		platonecli admin sup approve <address> <operation>`,
	}
	...
	SupAdd = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		platonecli admin sup add <name> <address> <roles>
The format of the <roles> is '["<role1>, <role2>, ..."]'`,
	...
	SupDelete = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		platonecli admin sup delete <address> <roles>`,
	}
