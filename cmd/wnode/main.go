...
import (
	...
	"github.com/PlatONEnetwork/PlatONE-Go/whisper/mailserver"
...
var (
	...
	argIP      = flag.String("ip", "", "IP address and port of this node (e.g. 127.0.0.1:16789)")
...
func initialize() {
	log.Root().SetHandler(log.LvlFilterHandler(log.Lvl(*argVerbosity), log.StreamHandler(os.Stdout, log.TerminalFormat(false))))
