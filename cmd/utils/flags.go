...
var (
	...
	VersionFlag = cli.StringFlag{
		Name:  "version",
		Usage: `the version of current blockchain,default 1.0.0`,
		Value: "1.0.0",
	}
...
func MakeChain(ctx *cli.Context, stack *node.Node) (chain *core.BlockChain, chainDb ethdb.Database) {
	...
	chain, _, err = core.NewBlockChain(chainDb, nil, cache, config, engine, vmcfg, nil)
	if err != nil {
...
// new format.
//
// e.g. platone account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// platone --keystore /tmp/mykeystore --lightkdf account new
//
