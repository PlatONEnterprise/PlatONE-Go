...
unless (caller) {
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '/home/wxuser/Desktop/release/PlatONE-Go/life/resolver/sm2/openssl/util/perl';
        use OpenSSL::fallback '/home/wxuser/Desktop/release/PlatONE-Go/life/resolver/sm2/openssl/external/perl/MODULES.txt';
...
use lib '/home/wxuser/Desktop/release/PlatONE-Go/life/resolver/sm2/openssl/Configurations';
use lib '.';
use platform;
_____
