...
var GasTable = [256]Instruction{
	...
	opcodes.Select: {
		Execute: nil,
		GasCost: constGasFunc(21),
	},
	opcodes.I32Const: {
		Execute: nil,
		GasCost: constGasFunc(7),
	},
	opcodes.I32Add: {
		Execute: nil,
		GasCost: constGasFunc(14),
	},
	opcodes.I32Sub: {
		Execute: nil,
		GasCost: constGasFunc(14),
	...
	opcodes.I32DivS: {
		Execute: nil,
		GasCost: constGasFunc(17),
	},
	opcodes.I32DivU: {
		Execute: nil,
		GasCost: constGasFunc(16),
	},
	opcodes.I32RemS: {
		Execute: nil,
		GasCost: constGasFunc(18),
	},
	opcodes.I32RemU: {
		Execute: nil,
		GasCost: constGasFunc(16),
	...
	opcodes.I32GeU: {
		...
		opcodes.I64DivS: {
			Execute: nil,
			GasCost: constGasFunc(28),
		},
		opcodes.I64DivU: {
			Execute: nil,
			GasCost: constGasFunc(25),
		},
		opcodes.I64RemS: {
			Execute: nil,
			GasCost: constGasFunc(26),
		},
		opcodes.I64RemU: {
			Execute: nil,
			GasCost: constGasFunc(25),
		...
		opcodes.F32Div: {
			Execute: nil,
			GasCost: constGasFunc(85),
		},
		opcodes.F32Sqrt: {
			Execute: nil,
			GasCost: constGasFunc(67),
		},
		opcodes.F32Min: {
			Execute: nil,
			GasCost: constGasFunc(128),
		},
		opcodes.F32Max: {
			Execute: nil,
			GasCost: constGasFunc(128),
		...
		opcodes.I64Load: {
			Execute: nil,
			GasCost: constGasFunc(24),
		},

		opcodes.I32Store: {
			Execute: nil,
			GasCost: constGasFunc(30),
		},
		opcodes.I64Store: {
			Execute: nil,
			GasCost: constGasFunc(29),
		},

		opcodes.I32Load8S: {
			Execute: nil,
			GasCost: constGasFunc(20),
		},
		opcodes.I32Load16S: {
			Execute: nil,
			GasCost: constGasFunc(21),
