...
func TestEIP155ChainId(t *testing.T) {
	...
	tx = NewTransaction(0, addr, new(big.Int), 0, new(big.Int), nil, common.DefaultTxType)
...
func TestChainId(t *testing.T) {
	...
	tx := NewTransaction(0, common.Address{}, new(big.Int), 0, new(big.Int), nil, common.DefaultTxType)
