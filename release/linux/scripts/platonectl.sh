...
SCRIPT_PATH=${WORKSPACE_PATH}/chain/PlatONE_linux/script
...
function clear() {
    ...
    --nodeid | -n)
        ...
        NODE_DIR=${WORKSPACE_PATH}/chain/PlatONE_linux/data/node-${2}
    ...
    --all | -a)
        ...
        data=${WORKSPACE_PATH}/chain/PlatONE_linux/data
        rm -rf ${data}/*
