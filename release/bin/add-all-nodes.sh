...
publicKeyA=`cat ../../dataA/node.pubkey`
publicKeyB=`cat ../../dataB/node.pubkey`
publicKeyC=`cat ../../dataC/node.pubkey`

nodeJsonStr_string="{\"name\":\"node\",\"type\":1,\"publicKey\":\"${publicKey}\",\"desc\":\"desc\",\"externalIP\":\"127.0.0.1\",\"internalIP\":\"127.0.0.1\",\"rpcPort\":6791,\"p2pPort\":16791,\"root\":true,\"owner\":\"0x${account}\",\"status\":1}"
